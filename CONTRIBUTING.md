...
Envy TUI is open to pull requests, issue reports, and questions from the community. Here are some good ways to get help if you need it.
...
Envy TUI is written in [Rust](https://www.rust-lang.org/tools/install) and uses [Cargo](https://doc.rust-lang.org/cargo/guide/) to manage dependencies.
...
```sh
$ git clone https://github.com/FormidableLabs/cli-network-viewer.git
$ cd cli-network-viewer
```
